...
| Network Policy | 20% |
| Service Mesh | 10% |
| Network Observability | 15% |
| Cluster Mesh | 10% |
| eBPF | 10% |
| BGP and External Networking | 10% |
| Cilium CLI and Hubble | 15% |

## Key Topics

### Architecture
- Cilium components (agent, operator, CNI)
- eBPF datapath
- Identity-based security

### Network Policy
- Cilium Network Policies
- L3/L4 and L7 policies
- Host policies
...
- [CCA Curriculum](https://github.com/cncf/curriculum)
