...
Welcome to the **Cilium Basics Associate (CBA)** interactive demo exam! Test your knowledge with **54 questions** covering Cilium networking, security, and observability.
...
<div class="quiz-container" id="quizApp">
  <div class="quiz-header">
    ...
    <div class="quiz-stats">
      ...
      <div class="stat-box"><div class="stat-number">~81</div><div class="stat-label">Minutes</div></div>
    </div>
...
function startQuiz(m) {
  ...
  if (mode === 'timed') { timeLeft = 81 * 60; document.getElementById('timerDisplay').style.display = 'inline-block'; startTimer(); }
  showQuestion();
}
